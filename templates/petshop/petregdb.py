...
class DBConnection:
    ...
    @classmethod
    def create_pets(cls):
        cls.cur.execute(f'create table if not exists pets(pid serial primary key, ptype varchar(10), pbreed varchar(20), pname varchar(20),  page int, pown varchar(20));')
        cls.con.commit()
    ...
    def delete_pets(cls,delid):
        cls.cur.execute(f"delete from pets where pname='{delid}'")
        cls.con.commit()
